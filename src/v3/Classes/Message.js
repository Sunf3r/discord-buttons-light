const Message = require("discord.js-light").Structures.get('Message');
const ButtonCollector = require('discord-buttons/src/v3/Classes/ButtonCollector');
const APIMessage = require('discord-buttons/src/v3/Classes/APIMessage').APIMessage;
const BaseMessageComponent = require('discord-buttons/src/v3/Classes/interfaces/BaseMessageComponent');
